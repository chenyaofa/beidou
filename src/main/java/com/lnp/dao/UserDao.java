...
public interface UserDao {
    //根据用户名密码验证是否登录成功
    public UserInformation SelectUser(@Param("usernameOruserman")String usernameOruserman, @Param("password")String password);
    ...
    //分页查询
    public List<OrderInformation> findList(OrderInformation orderInformation,@Param("pageIndex")Integer pageIndex,@Param("pagesize")Integer pagesize);
    ...
    //增加订单的方法
    public int orderAdd(OrderInformation orderInformation);
    ...
    //退款申请信息转移操作
    public int sanctionOrder(OrderInformation orderInformation,@Param("receiverAddress")String receiverAddress);

    //审批通过
    public AfterOrder goSanction(@Param("orderId")String orderId);
