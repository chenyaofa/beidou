...
<div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <c:if test="${userSession.companyId==1||userSession.companyId==2||userSession.companyId==3}">
                    ...
                    <li class="layui-nav-item layui-nav-itemed">
					    ...
					    box-shadow: #cde2fa;" href="${pageContext.request.contextPath}/Recycle/goRecycleBin"> &nbsp;&nbsp;订单回收站</a></dd>
    ...
    <div class="layui-body">
        ...
        <form action="${pageContext.request.contextPath}/Recycle/findRecycleBin" method="post">
...
<%--                    </p>--%>
    ...
    <button class="btnA" type="button" onclick="okc()">开始查询</button>
        ...
        <div align="center"><button class="clear" id="killAll">清空回收站</button></div>
        <!--底部分页设置-->
...
<script type="text/javascript">
        ...
        layer.open({
            ...
            ,yes: function(index, layero){
                ...
                layer.open({
                    ...
                    ,yes: function(index, layero){
                        //按钮【按钮一】的回调
                        window.location.href="${pageContext.request.contextPath}/Recycle/deleteAll";
                    }
                });
            ...
            ,yes: function(index, layero){
                ...
                layer.open({
                    ...
                    ,yes: function(index, layero){
                        ...
                        window.location.href="${pageContext.request.contextPath}/Recycle/deleteRecycle?orderId="+theId;
                    }
                });
    ...
    function getData(curr,limit) {
        ...
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/Recycle/findRecycleBin",
            dataType: "json",
            data: {
                orderId: orderId,
                orderTime: orderTime,
            ...
            success: function(result) {
                ...
                $.each(list,function(index,item){
                    ...
                    html+='<td><a orderId=\''+item.orderId+'\' href=\'${pageContext.request.contextPath}/Recycle/goBackRecycleBin?orderId='+item.orderId+'\' title=\'恢复\'>恢复</a></td>';
                    html+='<td><a orderId=\''+item.orderId+'\' class=\'panel-box-edit\' onclick="isDelete(this)" title=\'删除订单信息\'>删除</a></td></tr>';
                })
                $('#tableList').html(html);
