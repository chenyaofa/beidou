    ...
    <div id="container1">
        ...
        <div class="mid" >
            ...
            <div class="mid1" style="height: 660px">
                <form method="post" action="${pageContext.request.contextPath}/store/UpdateStore">
                    <div class="mid2" >
                        <span  id="p1">门店修改</span>
                        <img src="${pageContext.request.contextPath}/statics/images/cebulan.png" style="height:28px;" />
                        <span id="p2">请输入门店信息</span>
                    </div>
                    <div class="mid3">
                        <input type="hidden" name="storeId" value="${storeList.storeId}">
                        <table>
                            <tr>

                                <th>门店名称:</th>
                                <td><input type="text" name="storeName" maxlength="10" value="${storeList.storeName}" id="storeName" class="n1" /></td>
                            </tr>
                            <tr>
                                <th>门店店主:</th>
                                <td><input type="text" name="storeOwner" value="${storeList.storeOwner}" maxlength="10" id="storeOwner" class="n2" /></td>
                            </tr>
                            <tr>
                                <th>联系方式:</th>
                                <td><input type="text" name="contactWay" maxlength="11" value="${storeList.contactWay}" id="contactWay" class="n3" /></td>
                            </tr>
                            <tr class="tr1">
                                <th>门店地址:</th>
                                <td><input type="text" placeholder="请输入详细地址" id="detailedness" maxlength="30" name="detailedness" value="${address[3]}" class="n4" /></td>
                                <input id="addr" name="shipAddress" type="hidden" />
                            </tr>
                            <p id="sss" data-toggle="distpicker" >
                                <select name="shen" class="h1" data-province="${address[0]}"></select>
                                <select name="shi" class="h1" data-city="${address[1]}" style="top: 40px;"></select>
                                <select name="xian" class="h1" data-district="${address[2]}" style="top: 80px;"></select>
                            </p>
                    ...
                    <div class="mid4">
                        <span><input onclick="copy()" type="button" value="点击修改门店信息" id="name" /></span>
                        <div class="back">
